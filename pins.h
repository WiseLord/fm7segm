...
/* Pinout selection
 *
 * PIN1 is a pinout for schematic in article
 * http://radiokot.ru/circuit/digital/home/202/
 *
 * PIN2 is one for schematic in first pages of forum thread
 * http://www.radiokot.ru/forum/viewtopic.php?t=109632
 */

#if !defined(_PIN1) && !defined(_PIN2)
#define _PIN1
#endif
